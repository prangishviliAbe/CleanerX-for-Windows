# Cleaner X - Windows Computer Cleaner
...
- **Browser Cache Cleanup** - Clean Chrome, Edge, Firefox, and Opera caches
...
```bash
git clone https://github.com/prangishviliAbe/CleanerX.git
```
